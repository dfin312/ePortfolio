...
namespace
{
    ...
    // Cube and light color  ***Need to figure out how to allow for texture or new color input**
    ...
    //Texture ID                      //Attempting to add texture to the scene 
...
int main(int argc, char* argv[])
{
    ...
    const char* texFilename = "Users/dfin3/Desktop/SchoolWork/CS330/CS-330-master(CS499)/resources/textures/blueDesk.png";
    if (!UCreateTexture(texFilename, gTextureBlueDesk)) {
        cout << "Failed to load texture " << texFilename << endl;
        return EXIT_FAILURE;
    }
    texFilename = "Users/dfin3/Desktop/SchoolWork/CS330/CS-330-master(CS499)/resources/textures/checkerboard.png";
...
// --------------------
    ...
    UDestroyTexture(gTextureCheckerboard);
